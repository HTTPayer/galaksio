          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:gap-16">
            ...
            <div className="lg:w-1/2">
              ...
              <div className="mt-10 flex flex-wrap items-center gap-4">
                ...
                <Link
                  href="/glusd"
                  className="flex items-center gap-2 rounded-lg border border-blue-950 bg-white px-6 py-3 text-sm font-semibold text-blue-950 transition-all hover:bg-blue-50"
                >
                  <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function FeatureCard({
  ...
  if (link) {
    return (
      <Link href={link} className="block rounded-xl border border-zinc-200 p-6 transition-all hover:border-blue-950 hover:shadow-lg">
        <CardContent />
      </Link>
    );
  }
